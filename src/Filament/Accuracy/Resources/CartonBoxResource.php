...
namespace Xbigdaddyx\Accuracy\Filament\Accuracy\Resources;

use AlperenErsoy\FilamentExport\Actions\FilamentExportBulkAction;
use AlperenErsoy\FilamentExport\Actions\FilamentExportHeaderAction;
use Xbigdaddyx\Accuracy\Filament\Accuracy\Resources\CartonBoxResource\Pages;
use Xbigdaddyx\Accuracy\Filament\Accuracy\Resources\CartonBoxResource\RelationManagers;
use Xbigdaddyx\Accuracy\Filament\Accuracy\Resources\CartonBoxResource\RelationManagers\CartonBoxAttributesRelationManager;
use Xbigdaddyx\Accuracy\Filament\Accuracy\Resources\CartonBoxResource\RelationManagers\PackingListRelationManager;
...
class CartonBoxResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                // Tables\Filters\Filter::make('empty_po')
                //     ->label('Empty Po')
                //     ->query(fn (Builder $query): Builder => $query->doesntHave('packingList')),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'activities' => Pages\ViewCartonBoxActivities::route('/{record}/activities'),
        ];
    }
}
